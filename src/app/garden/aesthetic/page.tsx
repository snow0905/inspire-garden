...
export default function AestheticGardenPage() {
  const { data, error, isLoading } = useSWR('/api/garden/aesthetic', fetcher);
  const config = GARDEN_CONFIG.aesthetic;
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      {!isLoading && !error && <TopicGrid topics={topics} gardenId="aesthetic" />}
    </div>
  );
}
