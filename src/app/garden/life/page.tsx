...
export default function LifeGardenPage() {
  const { data, error, isLoading } = useSWR('/api/garden/life', fetcher);
  const config = GARDEN_CONFIG.life;
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      {!isLoading && !error && <TopicGrid topics={topics} gardenId="life" />}
    </div>
  );
}
