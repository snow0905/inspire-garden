...
export default function FoodGardenPage() {
  const { data, error, isLoading } = useSWR('/api/garden/food', fetcher);
  const config = GARDEN_CONFIG.food;
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      {!isLoading && !error && <TopicGrid topics={topics} gardenId="food" />}
    </div>
  );
}
