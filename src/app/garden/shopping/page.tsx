...
export default function ShoppingGardenPage() {
  const { data, error, isLoading } = useSWR('/api/garden/shopping', fetcher);
  const config = GARDEN_CONFIG.shopping;
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      {!isLoading && !error && <TopicGrid topics={topics} gardenId="shopping" />}
    </div>
  );
}
